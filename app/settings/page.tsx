      ...
      <main className="max-w-lg mx-auto px-4 py-6 space-y-8">
        <section className="space-y-3">
          ...
          <p className="text-sm text-neutral-500">
            Signed in as <span className="font-medium text-neutral-700 dark:text-neutral-300">{user.email}</span>
          </p>
          <form onSubmit={handleAccountSubmit} className="space-y-3">
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full rounded-md border border-neutral-300 dark:border-neutral-700 bg-white dark:bg-neutral-900 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-sky-500"
              />
            </div>
            ...
            <button
              type="submit"
              disabled={saving}
              className="rounded-md bg-sky-600 text-white px-4 py-2 text-sm font-medium disabled:opacity-40"
            >
